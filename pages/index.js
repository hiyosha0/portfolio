            ...
            <main className=' bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
              <section className=' min-h-screen'>
                <nav className=' py-10 mb-12 flex
                 justify-between'>
                  <h1 className=' text-xl font-burtons dark:text-white'>Hiyosha</h1>
                ...
                <div className=' text-center p-10 py-10'>
                  <h2 className=' text-5xl py-2 font-medium text-teal-600 font-medium md:text-6xl'>Hiyosha Vinupama</h2>
                  <h3 className=' text-2xl py-2 font-medium md:text-3xl dark:text-white'>Developer and Designer</h3>
              ...
              <section>
                <div>
                  ...
                  <p className=' text-md py-2 leading-8 text-gray-800 dark:text-white'>Since the beginning of my journy as a Developer,Designer,
                    I have done many products.further I have built
                    <span className=' text-teal-500'> Web-Applications</span> and some incredible 
                    <span className=' text-teal-500'> UX-designs</span> and <span className=' text-teal-500 '>Digital-Designs</span>
                  </p>
                  <p className=' text-md py-2 leading-8 text-gray-800 dark:text-white'>
                    In addition to that I offfor wide range of services
                    such as Digital-Artworks,Front-end Devoloping,Figma app designs
                  </p>
                </div>
                <div className='lg:flex gap-10'>
                  <div className=' text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
                    <Image className=' object-center' src={design} width={100} height={100} />
                  ...
                  <div></div>
                  <div className=' text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
                    <Image className=' object-center' src={code} width={100} height={100} />
                    <h3 className=' text-lg font-medium pt-8 pb-2'>Beautiful Designs</h3>
